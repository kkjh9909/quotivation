...
@Service("category_popular")
@RequiredArgsConstructor
public class CategorySortPopularStrategy implements CategorySortStrategy {

    private final CategoryRepository categoryRepository;

    @Override
    public CategoryListInfo sort(Pageable pageable) {
        Page<Category> categories = categoryRepository.findAllByOrderByQuoteCountDesc(pageable);
